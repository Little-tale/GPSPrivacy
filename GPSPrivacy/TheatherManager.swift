...
enum TheaterData{
    static let megaBox = "메가박스"
    static let lotte = "롯데시네마"
    static let cGV = "CGV"
    static let all = "All"
    
//    func getFilterAnnotation() -> [MKAnnotation]{
//        var tempAnnotaion: [MKAnnotation] = []
